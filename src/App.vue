  ...
  <div class="container">
    <form v-if="!isSubmitted">
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          ...
          <div class="form-group">
            ...
            <input type="text" id="email" class="form-control" v-model.lazy.trim="userData.email">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" id="age" class="form-control" v-model.lazy.trim="userData.age">
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group">
          <label for="male">
            <!-- It's important to use the same v-model data property when using radio buttons -->
...
<br>
    ...
    <br>
    <div class="alert alert-success col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" v-if="isSubmitted">
        Form submitted succesffuly!
    </div>
